...
const CASES: Case[] = [
  ...
  ['strainTier', strainTierId('FERAL', 2), 'effect', `resets to ${STRAIN_PHYSICS.moltResetLength}`],
  ...
  ['strainTier', strainTierId('FERAL', 2), 'cost', `shorter than ${STRAIN_PHYSICS.moltResetLength}`],
