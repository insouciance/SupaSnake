...
const CASES: Case[] = [
  ...
  ['strainTier', strainTierId('FERAL', 2), 'effect', `Every ${STRAIN_PHYSICS.moltEveryFoods} foods`],
  ['strainTier', strainTierId('FERAL', 2), 'effect', `sheds to ${pct(STRAIN_PHYSICS.moltShedFraction)}`],
  ['strainTier', strainTierId('FERAL', 2), 'effect', `never below ${STRAIN_PHYSICS.moltMinLength}`],
  ['strainTier', strainTierId('FERAL', 2), 'effect', `drops ${STRAIN_ECONOMICS.moltFoodsPerEvent} molt foods`],
  ['strainTier', strainTierId('FERAL', 2), 'effect', `${STRAIN_ECONOMICS.moltFoodFlat} DNA each`],
  ['strainTier', strainTierId('FERAL', 2), 'cost', `×${STRAIN_PHYSICS.moltTickFactor}`],
  ['strainTier', strainTierId('FERAL', 2), 'cost', `shorter than ${STRAIN_PHYSICS.moltMinLength}`],
  ...
  ['anomaly', 'overgrown', 'effect', `${ANOMALY_ECONOMICS.overgrownMoltFoodFlat} DNA`],
