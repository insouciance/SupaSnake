...
> = {
  ...
  phase_gate: {
    ...
    effect: 'Step through a door to every 5th food for ×3.',
    cost: 'Both ends of the door become permanent Scars.',
    detail: 'Every fifth food opens a door. Step into the violet ring and you come out at the cyan one — instantly, still facing the same way, one step from the food, for triple. Both rings then harden into permanent Scars.',
    economics: 'path',
    category: 'terrain',
    dynasties: [],
  },
