 ...
 * normal DNA rules. The four launch anomalies:
 *
 ...
 * over the 4-anomaly pool - mirrored by anomaly_for_week in migration 021
 ...
 * Week N's anomaly is ANOMALY_ROTATION[weeksSinceEpoch(N) % 4].
 */
...
/**
 * The week's anomaly: index = whole weeks since the epoch Monday, mod 4.
