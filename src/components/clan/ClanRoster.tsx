                  ...
                  {contribution.hasEligibleContribution ? (
                    <div className="mt-3 grid grid-cols-3 gap-2" data-testid="member-contribution">
                      <div className="rounded-arcade bg-void/45 p-2">
                        ...
                        <p className="font-display text-bone-white">{contribution.bestFiveDepth == null ? undefined : formatAmount(contribution.bestFiveDepth)} <span className="text-xs text-beige/55">Depth</span></p>
                      </div>
                      <div className="rounded-arcade bg-void/45 p-2">
