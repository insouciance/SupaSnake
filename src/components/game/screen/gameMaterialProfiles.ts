...
export const GAME_MATERIAL_PROFILES: Record<DynastyId, GameMaterialProfile> = {
  CYBER: {
    snake: {
      ...
      headEmissiveIntensity: 0.78,
      bodyEmissiveIntensity: 0.34,
      headMetalness: 0.62,
      bodyMetalness: 0.24,
      headRoughness: 0.24,
      bodyRoughness: 0.52,
      bodyAlbedoScalar: 0.91,
  ...
  COSMIC: {
    snake: {
      ...
      headEmissiveIntensity: 0.7,
      bodyEmissiveIntensity: 0.31,
      headMetalness: 0.5,
      bodyMetalness: 0.18,
      headRoughness: 0.27,
      bodyRoughness: 0.55,
